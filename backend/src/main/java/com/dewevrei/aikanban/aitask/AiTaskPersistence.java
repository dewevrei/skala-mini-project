...
public class AiTaskPersistence {
    ...
    public List<TaskResponse> saveBatch(long userId, long projectId, String originalTitle,
        ...
        Context context = context(userId, projectId, ApiCode.TASK_BATCH_SAVE_FAILED);
        ...
        try {
            ...
            throw new DomainException(ApiCode.TASK_BATCH_SAVE_FAILED, exception);
        }
    }
    ...
    public List<TaskResponse> saveFallback(long userId, long projectId, String title,
            String description) {
        Context context = context(userId, projectId, ApiCode.TASK_FALLBACK_SAVE_FAILED);
        try {
            ...
            throw new DomainException(ApiCode.TASK_FALLBACK_SAVE_FAILED, exception);
        }
    }
